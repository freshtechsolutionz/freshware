        ...
        <main className="mx-auto max-w-3xl px-6 pb-16">
          <div className="rounded-3xl border bg-white p-8 shadow-sm">
            ...
            <p className="mt-3 text-sm text-gray-600">
              Your request has been submitted. You will receive access instructions from your workspace admin if approved.
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-white">
      ...
      <main className="mx-auto max-w-3xl px-6 pb-16">
        <div className="rounded-3xl border bg-white p-8 shadow-sm">
          ...
          <p className="mt-3 text-sm text-gray-600">
            Freshware is invite-only. If you need access to your organization’s workspace, submit your request below.
          </p>
